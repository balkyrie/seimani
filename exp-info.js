...
//	[	15,	"スズキ（仮）",			0,	"SR",	"00_.png"],
	...
	var stageTable=[
	[	"初級",	15,	4,	1500,	1050,	7,	7,	1	],
	[	"中級",	25,	4,	2625,	1800,	7,	7,	2	],
	[	"上級",	35,	4,	3850,	6650,	7,	7,	3	],
	[	"まつり",	40,	4,	4400,	8000,	7,	7,	5	],
	[	"ちまつり",	50,	4,	5500,	10500,	7,	7,	8	],
...
/*
	...
	[	"T4-K",	0,	4,	100,	0,	7,	7,	99	],
*/
	[	"H4-1",	0,	0,	3920,	4070,	3,	1,	7	],
	[	"H4-2",	0,	1,	3914,	4080,	4,	2,	7	],
	[	"H4-A",	0,	2,	4018,	4210,	5,	3,	7	],
	[	"H4-3",	0,	1,	4072,	4190,	6,	4,	7	],
	[	"H4-B",	0,	0,	4157,	4370,	0,	5,	7	],
	[	"H4-C",	0,	1,	4284,	4480,	1,	6,	7	],
	[	"H4-4",	0,	3,	4347,	4370,	2,	0,	7	],
	[	"H4-D",	0,	2,	4323,	4350,	3,	2,	7	],
	[	"H4-E",	0,	3,	4343,	4540,	4,	3,	7	],
	[	"H4-5",	0,	4,	4579,	4460,	5,	4,	7	],
	[	"N4-F",	0,	4,	100,	0	,	7,	7,	7	],
	[	"N4-G",	0,	4,	100,	0	,	7,	7,	7	],
	[	"N4-H",	0,	4,	100,	0	,	7,	7,	7	],
	[	"N4-I",	0,	4,	100,	0	,	7,	7,	7	],
	[	"N4-J",	0,	4,	100,	0	,	7,	7,	7	],
	[	"N4-K",	0,	4,	100,	0	,	7,	7,	7	],

	[	"N4-1",	25,	2,	2966,	2740,	1,	7,	6	],
	[	"N4-2",	25,	0,	3004,	2760,	2,	7,	6	],
	[	"N4-A",	0,	1,	1824,	2770,	7,	7,	6	],
	[	"N4-3",	25,	1,	3062,	2770,	7,	7,	6	],
	[	"N4-B",	0,	0,	1963,	2670,	7,	7,	6	],
	[	"N4-C",	0,	1,	2052,	2200,	7,	7,	6	],
	[	"N4-4",	0,	2,	2159,	2300,	7,	7,	6	],
	[	"N4-D",	0,	3,	2167,	2200,	7,	7,	6	],
	[	"N4-E",	0,	1,	2282,	2420,	7,	7,	6	],
	[	"N4-5",	0,	4,	2450,	2530,	7,	7,	6	],
	...
	[	"T3-1",	0,	0,	3920,	0,	7,	7,	99	],
	[	"T3-2",	0,	1,	3914,	0,	7,	7,	99	],
	[	"T3-A",	0,	2,	4018,	0,	7,	7,	99	],
	[	"T3-3",	0,	1,	4072,	0,	7,	7,	99	],
	[	"T3-B",	0,	0,	4157,	0,	7,	7,	99	],
	[	"T3-C",	0,	1,	4284,	0,	7,	7,	99	],
	[	"T3-4",	0,	3,	4347,	0,	7,	7,	99	],
	[	"T3-D",	0,	2,	4323,	0,	7,	7,	99	],
	[	"T3-E",	0,	3,	4343,	0,	7,	7,	99	],
	[	"T3-5",	0,	4,	4579,	0,	7,	7,	99	],
	[	"T3-F",	0,	4,	100,	0,	7,	7,	99	],
	[	"T3-G",	0,	4,	100,	0,	7,	7,	99	],
	[	"T3-H",	0,	4,	100,	0,	7,	7,	99	],
	[	"T3-I",	0,	4,	100,	0,	7,	7,	99	],
	[	"T3-J",	0,	4,	100,	0,	7,	7,	99	],
	[	"T3-K",	0,	4,	100,	0,	7,	7,	99	],
	...
	[	"T2-1",	37,	3,	3826,	4130,	6,	5,	8	],
	[	"T2-2",	38,	1,	4059,	4220,	0,	6,	8	],
	[	"T2-A",	38,	0,	4000,	4250,	1,	0,	8	],
	[	"T2-3",	39,	0,	4311,	4210,	2,	1,	8	],
	[	"T2-B",	40,	3,	4288,	4500,	3,	2,	8	],
	[	"T2-C",	40,	0,	4338,	4440,	4,	3,	8	],
	[	"T2-4",	40,	1,	4373,	4320,	5,	4,	8	],
	[	"T2-D",	0,	3,	2884,	0,	7,	7,	8	],
	[	"T2-E",	0,	2,	3068,	0,	7,	7,	8	],
	[	"T2-5",	0,	4,	3264,	0,	7,	7,	8	],
	[	"T2-F",	37,	2,	3795,	3980,	1,	0,	8	],
	[	"T2-G",	37,	0,	3928,	3950,	2,	1,	8	],
	[	"T2-H",	38,	1,	4124,	4060,	3,	7,	8	],
	[	"T2-I",	40,	2,	4308,	4260,	4,	3,	8	],
	[	"T2-J",	0,	1,	3206,	0,	7,	7,	8	],
	[	"T2-K",	0,	0,	3311,	0,	7,	7,	8	],
